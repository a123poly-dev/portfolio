...
(self.webpackChunk = self.webpackChunk || []).push([["802"], {
    5487: function() {
        window.tram = function(t) {
            ...
            }, h = window, p = "bkwld-tram", v = /[\-\.0-9]/g, m = /[A-Z]/, w = "number", g = /^(rgb|#)/, b = /(em|cm|mm|in|pt|pc|px)$/, y = /(em|cm|mm|in|pt|pc|px|%)$/, x = /(deg|rad|turn)$/, E = "unitless", k = /(all|none) 0s ease 0s/, _ = /^(width|height)$/, A = document.createElement("a"), L = ["Webkit", "Moz", "O", "ms"], T = ["-webkit-", "-moz-", "-o-", "-ms-"], C = function(t) {
                if (t in A.style)
                    return {
                        dom: t,
                        css: t
            ...
            if (O.transition) {
                var R = O.timing.dom;
                if (A.style[R] = d["ease-in-back"][0],
                !A.style[R])
                    for (var I in f)
                        d[I][0] = f[I]
            }
            var z = e.frame = (s = h.requestAnimationFrame || h.webkitRequestAnimationFrame || h.mozRequestAnimationFrame || h.oRequestAnimationFrame || h.msRequestAnimationFrame) && O.bind ? s.bind(h) : function(t) {
                h.setTimeout(t, 16)
            }
              , $ = e.now = (c = (u = h.performance) && (u.now || u.webkitNow || u.msNow || u.mozNow)) && O.bind ? c.bind(u) : Date.now || function() {
                return +new Date
            }
              , N = l(function(e) {
                function n(t, e) {
                ...
                function l() {
                    ...
                    this.el.style[O.transition.dom] = n)
                }
                function d(t, e, i) {
                    var r, o, a, s, u = e !== f, c = {};
                    for (r in t)
                ...
                e.init = function(e) {
                    ...
                    O.backface && H.hideBackface && B(this.el, O.backface.css, "hidden")
                }
                ,
                w("add", n),
                w("start", i),
            ...
            var B = t.style
              , U = t.css
              , G = {
                transform: O.transform && O.transform.css
            }
              , X = {
                color: [M, g],
            ...
            O.transform && O.backface && (Y.z = [y, "translateZ"],
            Y.rotateZ = [x],
            Y.scaleZ = [w],
            Y.perspective = [b]);
            var Z = /ms/
    ...
    5756: function(t, e, n) {
        var i, r, o, a, s, u, c, l, d, f, h, p, v, m, w, g, b, y, x, E, k = window.$, _ = n(5487) && k.tram;
        ...
        i.define("edit", t.exports = function(t, e, n) {
            ...
            return /[?&](update)(?:[=&?]|$)/.test(s.search) || /\?update$/.test(s.href) ? function() {
                ...
                if (e && n) {
                    ...
                    i && r && o && (a += "&domain=" + encodeURIComponent(o) + "&itemSlug=" + encodeURIComponent(i) + "&collectionId=" + r),
    ...
    5134: function(t, e, n) {
        ...
        function r(t, e, n) {
            ...
            i.initCustomEvent(e, !0, !0, n || null),
            t.dispatchEvent(i)
        }
        var o = window.jQuery
          , a = {}
    ...
    3949: function(t, e, n) {
        var i, r, o = {}, a = {}, s = [], u = window.Webflow || [], c = window.jQuery, l = c(window), d = c(document), f = c.isFunction, h = o._ = n(5756), p = o.tram = n(5487) && c.tram, v = !1, m = !1;
        function w(t) {
    ...
    1655: function(t, e, n) {
        ...
        i.define("navbar", t.exports = function(t, e) {
            var n, s, u, c, l = {}, d = t.tram, f = t(window), h = t(document), p = e.debounce, v = i.env(), m = ".w-nav", w = "w--open", g = "w--nav-dropdown-open", b = "w--nav-dropdown-toggle-open", y = "w--nav-dropdown-list-open", x = "w--nav-link-open", E = r.triggers, k = t();
            function _() {
                i.resize.off(A)
            }
            function A() {
            ...
            function L(n, i) {
                var r, a, s, l, d, p = t(i), v = t.data(i, m);
                v || (v = t.data(i, m, {
                    open: !1,
                    el: p,
                    config: {},
                ...
                v.button = p.find(".w-nav-button"),
                v.container = p.find(".w-container"),
                v.overlayContainerId = "w-nav-overlay-" + n,
                v.outside = ((r = v).outside && h.off("click" + m, r.outside),
                function(e) {
                    var n = t(e.target);
                    c && n.closest(".w-editor-bem-EditorOverlay").length || N(r, n)
                }
                );
                ...
                ))) : ((s = v).overlay || (s.overlay = t('<div class="w-nav-overlay" data-wf-ignore />').appendTo(s.el),
                s.overlay.attr("id", s.overlayContainerId),
                s.parent = s.menu.parent(),
                W(s, !0)),
                v.button.on("click" + m, z(v)),
                v.menu.on("click" + m, "a", $(v)),
                v.button.on("keydown" + m, (l = v,
                function(t) {
                    switch (t.keyCode) {
                    case o.SPACE:
                    case o.ENTER:
                ...
                function(t) {
                    if (d.open)
                        ...
                        case o.HOME:
                        case o.END:
                            return t.keyCode === o.END ? d.selectedIdx = d.links.length - 1 : d.selectedIdx = 0,
                            R(d),
                            t.preventDefault(),
                            t.stopPropagation();
                        case o.ESCAPE:
            ...
            function W(t, e) {
                if (t.open) {
                    ...
                    var n = t.config;
                    if (("none" === n.animation || !d.support.transform || n.duration <= 0) && (e = !0),
                    E.outro(0, t.el[0]),
                    a(t.el[0], "close"),
                    h.off("click" + m, t.outside),
                    e) {
                        d(t.menu).stop(),
                        u();
                        return
                    ...
                    var i = "transform " + n.duration + "ms " + n.easing2
                      ...
                      , s = t.el.height();
                    if (n.animOver)
                        return void d(t.menu).add(i).start({
                            x: o * n.animDirect
                        }).then(u);
