  ...
  return (
    <CaseLayout>
      ...
      <SectionBlock>
        ...
        >
          <div>
            <h3 className={styles.h5}>Simplified tables for MVP</h3>
            <p className={styles.paragraph}>
          ...
          <div>
            <h3 className={styles.h5}>Units</h3>
            <CaseImage
          ...
          <div>
            <h3 className={styles.h5}>Operators</h3>
            <CaseImage
          ...
          <div>
            <h3 className={styles.h5}>Routing</h3>
            <p className={styles.paragraph}>
          ...
          <div>
            <h3 className={styles.h5}>Dashboard</h3>
            <p className={styles.paragraph}>
          ...
          <div>
            <h3 className={styles.h5}>Webphone</h3>
            <p className={styles.paragraph}>
          ...
          <div>
            <h3 className={styles.h5}>Calls</h3>
            <p className={styles.paragraph}>
          ...
          <div>
            <h3 className={styles.h5}>Reports</h3>
            <CaseImage
